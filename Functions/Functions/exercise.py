...
# Add a function named list_benefits() that returns the 
...
# Add a function named build_sentence(One argument) 
    #which receives a single argument containing a string 
    
    #and returns a sentence starting with the given argument 
    #and ending with the string " is a benefit of functions!"

# Run and see all the functions work together!


# Modify this function to return a list 
# of strings as defined above
def list_benefits():
    return []
